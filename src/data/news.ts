/*
Custom images must be in a 16:9 aspect ratio.
When placing text inside the image, please ensure that the top and bottom one-third (1/3) of the image remain free of important content,
as these areas may be partially cropped on different screen sizes.
*/
